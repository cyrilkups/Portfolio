            ...
            <div className="container" ref={containerRef}>
                ...
                >
                    <div className="relative w-full">
                        ...
                        <div className="max-w-[635px] space-y-7 pb-10 mx-auto">
                            ...
                            {project.caseStudy && (
                                <div className="fade-in-later">
                                    ...
                                    <div className="text-lg">
                                        {parse(project.caseStudy)}
                                    </div>
                                </div>
                            )}
                            {(project.liveUrl || project.sourceCode) && (
                                <div className="fade-in-later mt-8 flex gap-4">
                                    {project.liveUrl && (
                                        <a
                                            href={project.liveUrl}
                                            target="_blank"
                                            rel="noreferrer noopener"
                                            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 text-lg font-anton hover:bg-primary/90 transition-colors"
                                        >
                                            VISIT WEBSITE
                ...
                <div
                    className="relative flex flex-col gap-2 max-w-[800px] mx-auto mt-[150px]"
                    id="images"
                >
                    {project.images.map((image) => (
                        <a
                            key={image}
                            href={
                                project.liveUrl || project.sourceCode || image
                            }
                            target="_blank"
                            rel="noreferrer noopener"
